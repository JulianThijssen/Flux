...
void main() {
    ...
    vec3 rvec = texture(noiseMap, pass_texCoords * vec2(1920/4, 1080/4)).xyz * 2.0 - 1.0;
    ...
    for (int i = 0; i < kernelSize; ++i) {
        ...
        float rangeCheck = abs(viewP.z - sampleDepth) < radius ? 1.0 : 0.0;
